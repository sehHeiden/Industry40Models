...
# ╔═╡ 0e10d120-1a90-11ee-072e-ffa8eb264273
md"""
# Neuronales ODE (nODE) mit Lux
"""
...
begin
	...
	ode_data = [T₁_t(tsteps) T₂_t(tsteps)]'
end

# ╔═╡ 4974cf95-ce06-47e5-8c0c-416b2be5b34d
prob_neuralode = NeuralODE(NN, tspan, DP5(), saveat = tsteps)

# ╔═╡ 1a8b7044-862a-48f7-b1af-53e51acebd85
function predict_neuralode(p)
  Array(prob_neuralode(T0, p, st)[1])
end

# ╔═╡ 2b58204b-2177-499b-8d8d-35ffb50b9ba1
...
# ╔═╡ 1f6b42fa-e9a3-46ae-ad2b-248d31c4c81c
...
# ╔═╡ 6ad1449f-bfc8-47a7-a89c-47877e529cd0
begin
...
# ╔═╡ 2adc3e1b-d71e-4d33-b603-57f8f6a99634
md"""
## Training nODE
...
# ╔═╡ 7bfbace9-8887-4098-91f7-6b8b93bb8ae5
begin
...
# ╔═╡ 035597fa-acd5-4919-bda5-5288f8dc85c8
begin
	optprob2 = remake(optprob,u0 = result_neuralode.u)
	result_neuralode2 = Optimization.solve(optprob2,
                                        Optim.BFGS(initial_stepnorm=1e-5),
                                        callback=callback,
                                        allow_f_increases = false,
										maxiters = 10000)
end

# ╔═╡ ab7fa98c-8495-4193-85f8-200bd84eba43
begin
	optprob3 = remake(optprob,u0 = result_neuralode2.u)
...
# ╔═╡ 8c237e9a-195e-40d2-860f-d274f9f3927b
callback(result_neuralode3.u, loss_neuralode(result_neuralode3.u)...; doplot=false)

# ╔═╡ c38a8c69-fb57-4ced-800d-a39163b5a2ad
md"""
## Plot der Heizkurven
"""

# ╔═╡ 2a8ff421-bc61-4259-8da7-42f609ae279f
begin
	y_predict_after = predict_neuralode(result_neuralode3.u)
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "ef52c13a28458dd31e8175928002b5ae0f4e578a"
...
version = "7.4.11"
weakdeps = ["BandedMatrices", "BlockBandedMatrices", "CUDA", "GPUArraysCore", "StaticArraysCore", "Tracker"]
...
git-tree-sha1 = "47960a253c1a759762504a8158d0afbfd7dccd61"
uuid = "b0b7db55-cfe3-40fc-9ded-d10e2dbeff66"
version = "0.13.14"
weakdeps = ["ConstructionBase", "GPUArrays", "RecursiveArrayTools", "ReverseDiff", "SciMLBase", "StaticArrays"]
...
git-tree-sha1 = "cc9b281d0def40e27bbd3728e7d6db7a4af68364"
...
git-tree-sha1 = "1db859508e955680c1b2ac8b5d514e284c21debf"
uuid = "b2108857-7c20-44ae-9111-449ecde12c47"
version = "0.4.51"
weakdeps = ["ComponentArrays", "FillArrays", "Flux", "ReverseDiff", "Tracker", "Zygote"]
...
git-tree-sha1 = "4b030477cb15d6d123ec39473520f1ab086f6ff0"
uuid = "bb33d45b-7691-41d6-9220-0943567d0623"
version = "0.1.4"

[[deps.LuxLib]]
deps = ["CUDA", "CUDAKernels", "ChainRulesCore", "KernelAbstractions", "Markdown", "NNlib", "NNlibCUDA", "Random", "Requires", "Statistics"]
git-tree-sha1 = "9fc45ac9d82a1908706b0a4b994f7132f8a94668"
uuid = "82251201-b29d-42c6-8e01-566dec8acb11"
version = "0.1.12"
weakdeps = ["ForwardDiff", "ReverseDiff", "Tracker"]
...
git-tree-sha1 = "c824e2d7a209a774afc491cb96f7bc9801cbb9fd"
